...
async def profile_handler(message: types.Message):
    logger.info(f"User pressed 'Настроить профиль'")
...
async def change_gender(message: types.Message):
    ...
    """
    logger.info(f"User pressed 'Изменить пол'")
...
async def change_sport(message: types.Message):
    ...
    """
    logger.info(f"User pressed 'Изменить вид спорта'")
...
async def change_intensity(message: types.Message):
    ...
    """
    logger.info(f"User pressed 'Изменить уровень нагрузки'")
